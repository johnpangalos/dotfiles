...
- **Key bindings**:
  ...
  - `<leader>gd` — Diff current buffer against index (gitsigns.nvim)
...
- **Plugins**: conform.nvim, nvim-lspconfig, nvim-treesitter, snacks.nvim, tokyonight.nvim, auto-dark-mode.nvim, wip.nvim, gitsigns.nvim
